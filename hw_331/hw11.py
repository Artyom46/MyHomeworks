...
def get_bad_startswith_letters(letters_set, cities_set):
    """
...
def check_bad_startwith_letter(city, bad_letters):
    """
...
def check_main_game_rule(last_round_city, current_round_city):
    """
...
def computer_move(cities_set, last_round_city):
    """
